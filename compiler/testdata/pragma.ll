...
@main.embedPacked = hidden global { ptr, i32, i32 } { ptr @"main$embedslice", i32 0, i32 0 }, align 4
@"main$embedslice" = internal global [0 x i8] zeroinitializer, align 1
@main.embedAligned = hidden global { ptr, i32, i32 } { ptr @"main$embedslice.1", i32 0, i32 0 }, align 16
@"main$embedslice.1" = internal global [0 x i8] zeroinitializer, align 16
@main.groupedAligned = hidden global [4 x i32] zeroinitializer, align 32
@main.groupedPlain = hidden global [4 x i32] zeroinitializer, align 4
@main.groupedEmbed = hidden global { ptr, i32, i32 } { ptr @"main$embedslice.2", i32 0, i32 0 }, align 16
@"main$embedslice.2" = internal global [0 x i8] zeroinitializer, align 16
